...
Applies a style_spec (from app.ai.prompts.styling) to match template appearance
...
from app.ai.prompts.styling import DEFAULT_STYLE_SPEC, normalise_style_spec
